...
<div class="row">
	<div class="col-md-12">
		...
		<ol class="breadcrumb">
		  <li><a href="dashboard.php">Lima Bionics</a></li>		  
		  <li class="active">Componentes</li>
		</ol>

		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="page-heading"> <i class="glyphicon glyphicon-edit"></i> Gestionar Componentes</div>
			</div> <!-- /panel-heading -->
			<div class="panel-body">
				...
				<div class="div-action pull pull-right" style="padding-bottom:20px;">
					<button class="btn btn-default button1" data-toggle="modal" id="addProductModalBtn" data-target="#addProductModal"> <i class="glyphicon glyphicon-plus-sign"></i> Agregar Componente </button>
				</div> <!-- /div-action -->				
    ...
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitProductForm" action="php_action/createProduct.php" method="POST" enctype="multipart/form-data">
	      <div class="modal-header">
	        ...
	        <h4 class="modal-title"><i class="fa fa-plus"></i> Agregar Componente</h4>
	      </div>
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	        ...
	        <div class="form-group">
	        	<label for="productName" class="col-sm-3 control-label">Componente: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="productName" placeholder="Componente" name="productName" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	    
	        ...
	        <div class="form-group">
	        	<label for="rate" class="col-sm-3 control-label">Precio de Compra (US$): </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="rate" placeholder="Precio de Compra" name="rate" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	     	        
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <select class="form-control" id="productStatus" name="productStatus">
				      	...
				      	<option value="2">Solicitado al proveedor*</option>
				      	<option value="3">En proceso de importación*</option>
						<option value="4">En aduanas*</option>
				      </select>
				    </div>
				<label class="col-sm-8 control-label">* Verificar Status </label>
	        </div> <!-- /form-group-->	         	        
	      </div> <!-- /modal-body -->
	      ...
	      <div class="modal-footer">
	        ...
	        <button type="submit" class="btn btn-primary" id="createProductBtn" data-loading-text="Loading..." autocomplete="off"> <i class="glyphicon glyphicon-ok-sign"></i> Guardar Data</button>
	      </div> <!-- /modal-footer -->	      
     	</form> <!-- /.form -->	     
    </div> <!-- /modal-content -->    
  </div> <!-- /modal-dailog -->
